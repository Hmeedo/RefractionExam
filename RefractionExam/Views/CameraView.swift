...
//  RefractionExam
//
//  Created by Hameed Dahabry on 04/07/2023.
//
...
struct CameraView: UIViewRepresentable {
    ...
    final public class Coordinator: NSObject, CameraViewDelegate {
        ...
        public func didUpdateFaceDetection(isFaceDetected: Bool) {
            DispatchQueue.main.async {
                guard self.cameraView.faceDetected != isFaceDetected else {
                    return
                }
                self.cameraView.faceDetected = isFaceDetected
                print("isFaceDetected", isFaceDetected)
            }
        }
    }
...
public protocol CameraViewDelegate: AnyObject {
    func didUpdateFaceDetection(isFaceDetected : Bool)
}

public class UICameraView: UIView, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    fileprivate func configureVideoDataOutput(for inputDevice: AVCaptureDevice, resolution: CGSize, captureSession: AVCaptureSession) {
        ...
        let videoDataOutputQueue = DispatchQueue(label: "com.hmeedo.RefractionExam.VisionFaceDetection")
    ...
    public func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        ...
        guard let requests = self.trackingRequests, !requests.isEmpty else {
            ...
            do {
                ...
                print("Failed to perform FaceRectangleRequest", error)
            }
            delegate?.didUpdateFaceDetection(isFaceDetected: false)
            return
        }
        ...
        do {
            ...
            print("Failed to perform SequenceRequest", error)
        }
        ...
        for trackingRequest in newTrackingRequests {
            ...
            let faceLandmarksRequest = VNDetectFaceLandmarksRequest(completionHandler: { [weak self] (request, error) in
                ...
                if results.count > 0 {
                    self?.delegate?.didUpdateFaceDetection(isFaceDetected: true)
                }
            })
